  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        {loading ? <div> <br></br><small> <a>Please allow up to five minutes to receive your reading...</a></small> <img src = {"https://i.pinimg.com/originals/fb/f4/b4/fbf4b4b5b982c142d6b25d8bf45daa40.gif"} alt="loading..." /> </div>: tarotReading && (
